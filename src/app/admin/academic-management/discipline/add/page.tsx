...
export default function AddDisciplinePage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      router.push('/admin/academic-management/discipline');
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-2xl font-bold text-foreground">Nova Disciplina</h1>
                <p className="text-sm text-muted-foreground">
                  Adicione uma nova disciplina ao sistema acadêmico
                </p>
              </div>
            </div>
