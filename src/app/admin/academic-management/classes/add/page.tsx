...
export default function AddClassePage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.log('Dados da classe:', formData);
      
      // Redirecionar para lista de classes
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-2xl font-bold text-foreground">Nova Classe</h1>
                <p className="text-sm text-muted-foreground">
                  Adicione uma nova classe ao sistema acadêmico
                </p>
              </div>
            </div>
