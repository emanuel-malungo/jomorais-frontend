...
export default function AddCreditNote() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Simular criação da nota de crédito
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-xl font-semibold text-foreground">Nova Nota de Crédito</h1>
                <p className="text-sm text-muted-foreground">Criar nova nota de crédito para estudante</p>
              </div>
            </div>
