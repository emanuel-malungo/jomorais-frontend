...
export default function EditTuition() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Simular atualização da propina
      await new Promise(resolve => setTimeout(resolve, 2000));
      router.push(`/admin/finance-management/tuitions/details/${params.id}`);
    } catch (error) {
      ...
      <Container>
        <div className="flex items-center justify-center min-h-[400px]">
          <div className="text-center">
            ...
            <p className="text-muted-foreground">Carregando dados da propina...</p>
          </div>
        </div>
      </Container>
    );
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-xl font-semibold text-foreground">Editar Propina</h1>
                <p className="text-sm text-muted-foreground">Atualizar configuração de propina</p>
              </div>
            </div>
